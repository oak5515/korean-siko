...
client.on('message', (message) => {
  ...
  if (message.content.startsWith('시코야 가능')) { //The 8ball Message
      ...
      if (message.content.startsWith('시코야 도박')) { //The 8ball Message
        var msg1 = Array(5); 
        msg1[1] = "**꽝!** 아쉽습니다... 약 96.154% 확률이군요...";
        msg1[2] = "**4등!** 괜찮은 수확이네요. 약 2.024% 확률이군요...";
        msg1[3] = "**3등!** 오 좋은데요? 약 1.012% 확률이군요...";
        msg1[4] = "**2등!** 오늘 운이 좋으시네요? 약 0.506% 확률이군요!";
        msg1[5] = "**1등!!** 대박! 행운이 넘치시네요! 약 0.202% 확률이에요!"
        msg1[6] = "**0등...?** 엥..? 이게 왜 나오죠? 약 0.101% 확률인데...?" 
